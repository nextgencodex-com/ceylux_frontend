    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="relative h-[400px] sm:h-[500px] lg:h-[600px] rounded-2xl sm:rounded-3xl overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-2 sm:px-4">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-2 sm:mb-4 drop-shadow-lg agbalumo-font">
              About <span className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl">Us</span>
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl mb-1 sm:mb-2 drop-shadow-md font-medium agbalumo-font">
              Built on Trust, Driven by Travel
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              <span className="gradient-mix agbalumo-font">Our Story</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover the journey that brought Sri Lanka Tour Connect to life and our passion for showcasing Sri Lanka's beauty
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold gradient-mix">A Journey of Discovery</h3>
              <p className="text-gray-700 leading-relaxed">
                Founded with a deep love for Sri Lanka's rich culture, stunning landscapes, and warm hospitality, 
                Sri Lanka Tour Connect was born from a simple dream: to share the magic of this incredible island with travelers 
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              <span className="gradient-mix agbalumo-font">Our Mission</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-bold gradient-mix mb-3">Authentic Experiences</h3>
            ...
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-bold gradient-mix mb-3">Sustainable Tourism</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-bold gradient-mix mb-3">24/7 Support</h3>
              <p className="text-gray-600">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              <span className="gradient-mix agbalumo-font">Our Team</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              />
              <h3 className="text-xl font-bold gradient-mix mb-2">Travel Experts</h3>
            ...
            <div className="text-center">
              <img 
                ...
                className="w-32 h-32 rounded-full object-cover mx-auto mb-4 shadow-lg"
              />
              <h3 className="text-xl font-bold gradient-mix mb-2">Local Guides</h3>
            ...
            <div className="text-center">
              <img 
                ...
                className="w-32 h-32 rounded-full object-cover mx-auto mb-4 shadow-lg"
              />
              <h3 className="text-xl font-bold gradient-mix mb-2">Customer Support</h3>
            ...
            <div className="text-center">
              <img 
                ...
                className="w-32 h-32 rounded-full object-cover mx-auto mb-4 shadow-lg"
              />
              <h3 className="text-xl font-bold gradient-mix mb-2">AI Specialists</h3>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              <span className="gradient-mix agbalumo-font">Why Choose Sri Lanka Tour Connect?</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-gradient-to-r from-[#3b82f6]/20 via-[#22c55e]/20 to-[#eab308]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <span className="text-black font-bold text-sm">1</span>
                </div>
                <div>
                  <h3 className="text-xl font-bold gradient-mix mb-2">Local Expertise</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold gradient-mix mb-2">Personalized Service</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold gradient-mix mb-2">Quality Assurance</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold gradient-mix mb-2">Innovation</h3>
        ...
        <div className="text-center bg-gradient-to-r from-[#3b82f6]/20 via-[#22c55e]/20 to-[#eab308]/20 rounded-2xl p-8 text-black">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              className="bg-cyan-400 text-black px-8 py-3 rounded-full font-semibold hover:bg-cyan-500 transition-colors"
              onClick={navigateToAI}
            >
              Plan Your Trip With AI
            </button>
